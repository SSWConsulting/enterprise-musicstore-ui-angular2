...
namespace SSW.MusicStore.Models
{
    public static class SampleData
    {
        ...
        private static async Task CreateAdminUser(IServiceProvider serviceProvider)
        {
            ...
            var userManager = serviceProvider.GetService<UserManager<SSW.MusicStore.Models.ApplicationUser>>();
            ...
            if (user == null)
            {
                user = new SSW.MusicStore.Models.ApplicationUser { UserName = configuration[defaultAdminUserName] };
