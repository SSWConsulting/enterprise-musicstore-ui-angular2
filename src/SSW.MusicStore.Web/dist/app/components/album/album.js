System.register(['angular2/core', 'angular2/common', 'angular2/router', '../../route.config', '../../services/album/album.service', '../../services/cart/cart.service', './album-template'], function(exports_1) {
    ...
    var core_1, common_1, router_1, route_config_1, album_service_1, cart_service_1, album_template_1;
    ...
    return {
        setters:[
            ...
            function (album_template_1_1) {
                album_template_1 = album_template_1_1;
            }],
        execute: function() {
            AlbumDetailComponent = (function () {
                ...
                AlbumDetailComponent = __decorate([
                    core_1.Component({
                        ...
                        directives: [common_1.CORE_DIRECTIVES, common_1.FORM_DIRECTIVES, album_template_1.AlbumTemplate]
                    }), 
