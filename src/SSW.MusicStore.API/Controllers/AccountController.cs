...
using SSW.MusicStore.API.ViewModels.Account;
...
namespace SSW.MusicStore.API.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            EnsureDatabaseCreated(_musicStoreContext);
            ViewData["ReturnUrl"] = returnUrl;
        ...
        private static void EnsureDatabaseCreated(MusicStoreContext context)
        {
            if (!_databaseChecked)
            {
